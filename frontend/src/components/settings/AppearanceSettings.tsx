...
const AppearanceSettings: Component = () => {
  ...
  return (
    <section class="bg-gray-100 dark:bg-gray-800 p-6 rounded-lg shadow-md">
      <h2 class="text-2xl font-semibold text-gray-900 dark:text-gray-100">Change Appearance</h2>
      <p class="mt-2 text-gray-600 dark:text-gray-300">
        Adjust your theme settings to suit your preference.
      </p>

      <div class="mt-4 flex items-center space-x-4">
        <span class="text-gray-900 dark:text-gray-100 mr-3">Light Mode</span>
        ...
        <span class="text-gray-900 dark:text-gray-100 ml-3">Dark Mode</span>
      </div>
    </section>
  );
};
