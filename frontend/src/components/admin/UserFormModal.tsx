...
const UserFormModal: Component<UserFormModalProps> = (props) => {
  ...
  return (
    <div class="fixed bg-inherit inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div class="p-6 rounded shadow-md w-96 bg-slate-300 dark:bg-slate-800 relative">
        <h3 class="text-lg font-bold mb-4 text-gray-600 dark:text-gray-200">New User</h3>
        <div class="mb-4">
