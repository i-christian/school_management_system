...
const Admin: Component = () => {
  ...
  const [cachedComponents, setCachedComponents] = createSignal(
    new Set<string>()
  );
      ...
      <nav class="mb-6">
        <div class="flex flex-wrap justify-center gap-2 sm:gap-4">
          <button
            ...
            class={`py-2 px-4 sm:px-6 rounded-lg text-sm sm:text-base font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500 ${
      ...
      <div class="mt-4">
        <Switch>
          ...
          <Match
            when={
              currentSection() === "assignments" &&
              cachedComponents().has("assignments")
            }
          >
            {" "}
